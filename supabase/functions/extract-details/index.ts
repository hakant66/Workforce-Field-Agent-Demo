...
const systemPrompt = `You are a technical data clerk. Extract the following JSON from the field engineer's transcript:
{
  "site": "ID | Name",
  "asset": "ID | Name",
  "description": "Technical summary of work done",
        ...
        tools: [
          {
            ...
            function: {
              ...
              description: "Extract structured job details from a field engineer transcript.",
              parameters: {
                type: "object",
                properties: {
                  site: { type: "string", description: "Site ID or name" },
                  asset: { type: "string", description: "Asset ID or name" },
                  description: { type: "string", description: "Technical summary of work done" },
                  outcome: { type: "string", enum: ["Completed", "Incomplete"] },
                  confidence: { type: "number", description: "Confidence score 0-100" },
                },
                required: ["site", "asset", "description", "outcome", "confidence"],
